...
The launcher creates a Python virtual environment and installs the tested dependencies. Complete the Microsoft sign-in using an account with access to your ReliefRN Foundry project. When the terminal says it is connected, open http://localhost:8000. Keep the terminal open while presenting. Python 3.10 or newer is recommended. Node.js is not needed to run the app.
